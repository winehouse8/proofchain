...
| `trace-change.sh` | PostToolUse | src/tests/ 변경 추적 (change-log.jsonl) + @tc/@req 누락 경고 + 팬텀 TC 참조 경고 |
| `artifact-commit.sh` | PostToolUse | SPEC/TC JSON 수정 시 개별 자동 git commit (ISO 26262 §7.4.5 형상 이력) |
